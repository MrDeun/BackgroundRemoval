...
train_loader = torch.utils.data.DataLoader(
    torchvision.datasets.CocoDetection(base_path+'/CocoDatasets/coco2017/train2017/',base_path+'/CocoDatasets/coco2017/annotations/instances_train2017.json',
...
test_loader = torch.utils.data.DataLoader(
    torchvision.datasets.CocoDetection(base_path+'/CocoDatasets/coco2017/test2017',base_path+'/CocoDatasets/coco2017/annotations/instances_val2017.json',
                             transform=torchvision.transforms.Compose([
                               torchvision.transforms.PILToTensor(),
                                torchvision.transforms.Resize((256, 256)),
                               torchvision.transforms.Normalize(
